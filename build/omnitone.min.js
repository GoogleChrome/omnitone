...
!function(A,t){"object"==typeof exports&&"undefined"!=typeof module?module.exports=t():"function"==typeof define&&define.amd?define(t):(A="undefined"!=typeof globalThis?globalThis:A||self).Omnitone=t()}(this,function(){"use strict";
/**
   * @license
   * Copyright 2016 Google Inc. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */const A={};let t,e,i,n,o,r,s,a,h,f,g,w,c,D,v,P,B,u,l,Q,C,_,d,E,M,p,I,x,m;A.log=function(){const A=`[Omnitone] ${Array.prototype.slice.call(arguments).join(" ")} (${performance.now().toFixed(2)}ms)`;"undefined"!=typeof window&&window.console&&window.console.log(A)},A.throw=function(){const A=`[Omnitone] ${Array.prototype.slice.call(arguments).join(" ")} (${performance.now().toFixed(2)}ms)`;throw new Error(A)},A.invertMatrix4=function(A,b){return t=b[0],e=b[1],i=b[2],n=b[3],o=b[4],r=b[5],s=b[6],a=b[7],h=b[8],f=b[9],g=b[10],w=b[11],c=b[12],D=b[13],v=b[14],P=b[15],B=t*r-e*o,u=t*s-i*o,l=t*a-n*o,Q=e*s-i*r,C=e*a-n*r,_=i*a-n*s,d=h*D-f*c,E=h*v-g*c,M=h*P-w*c,p=f*v-g*D,I=f*P-w*D,x=g*P-w*v,m=B*x-u*I+l*p+Q*M-C*E+_*d,m?(m=1/m,A[0]=(r*x-s*I+a*p)*m,A[1]=(i*I-e*x-n*p)*m,A[2]=(D*_-v*C+P*Q)*m,A[3]=(g*C-f*_-w*Q)*m,A[4]=(s*M-o*x-a*E)*m,A[5]=(t*x-i*M+n*E)*m,A[6]=(v*l-c*_-P*u)*m,A[7]=(h*_-g*l+w*u)*m,A[8]=(o*I-r*M+a*d)*m,A[9]=(e*M-t*I-n*d)*m,A[10]=(c*C-D*l+P*B)*m,A[11]=(f*l-h*C-w*B)*m,A[12]=(r*E-o*p-s*d)*m,A[13]=(t*p-e*E+i*d)*m,A[14]=(D*u-c*Q-v*B)*m,A[15]=(h*Q-f*u+g*B)*m,A):null},A.isDefinedENUMEntry=function(A,t){for(const e in A)if(t===A[e])return!0;return!1},A.isAudioContext=function(A){return A instanceof AudioContext||A instanceof OfflineAudioContext},A.isAudioBuffer=function(A){return A instanceof AudioBuffer},A.mergeBufferListByChannel=function(t,e){const i=e[0].length,n=e[0].sampleRate;let o=0;for(let t=0;t<e.length;++t)o>32&&A.throw("Utils.mergeBuffer: Number of channels cannot exceed 32.(got "+o+")"),i!==e[t].length&&A.throw("Utils.mergeBuffer: AudioBuffer lengths are inconsistent. (expected "+i+" but got "+e[t].length+")"),n!==e[t].sampleRate&&A.throw("Utils.mergeBuffer: AudioBuffer sample rates are inconsistent. (expected "+n+" but got "+e[t].sampleRate+")"),o+=e[t].numberOfChannels;const r=t.createBuffer(o,i,n);let s=0;for(let A=0;A<e.length;++A)for(let t=0;t<e[A].numberOfChannels;++t)r.getChannelData(s++).set(e[A].getChannelData(t));return r},A.splitBufferByChannel=function(t,e,i){e.numberOfChannels<=i&&A.throw("Utils.splitBuffer: Insufficient number of channels. ("+e.numberOfChannels+" splitted by "+i+")");const n=[];let o=0;const r=Math.ceil(e.numberOfChannels/i);for(let A=0;A<r;++A){const A=t.createBuffer(i,e.length,e.sampleRate);for(let t=0;t<i;++t)o<e.numberOfChannels&&A.getChannelData(t).set(e.getChannelData(o++));n.push(A)}return n},A.getArrayBufferFromBase64String=function(A){const t=window.atob(A),e=new Uint8Array(t.length);return e.forEach((A,i)=>e[i]=t.charCodeAt(i)),e.buffer};
/**
   * @license
   ...
   * limitations under the License.
   */
const b={BASE64:"base64",URL:"url"};function O(A,t,e,i){const n=A.decodeAudioData(t,e,i);n&&"function"==typeof n.catch&&n.catch(()=>{})}function y(t,e,i){this._context=A.isAudioContext(t)?t:A.throw("BufferList: Invalid BaseAudioContext."),this._options={dataType:b.BASE64,verbose:!1},i&&(i.dataType&&A.isDefinedENUMEntry(b,i.dataType)&&(this._options.dataType=i.dataType),i.verbose&&(this._options.verbose=Boolean(i.verbose))),this._bufferList=[],this._bufferData=this._options.dataType===b.BASE64?e:e.slice(0)}y.prototype.load=function(){const t=this._bufferData.map((A,t)=>this._options.dataType===b.BASE64?this._launchAsyncLoadTask(t):this._launchAsyncLoadTaskXHR(t));return Promise.all(t).then(t=>{this._bufferList=t;const e=this._options.dataType===b.BASE64?this._bufferData.length+" AudioBuffers from Base64-encoded HRIRs":this._bufferData.length+" files via XHR";return A.log("BufferList: "+e+" loaded successfully."),t})},y.prototype._launchAsyncLoadTask=function(t){return new Promise((e,i)=>{let n;try{n=A.getArrayBufferFromBase64String(this._bufferData[t])}catch(A){return void i(new Error("BufferList: invalid Base64 at index "+t))}O(this._context,n,i=>{this._options.verbose&&A.log("BufferList: ArrayBuffer("+t+") from Base64-encoded HRIR successfully loaded."),e(i)},e=>{const n='BufferList: decoding ArrayBuffer("'+t+'" from Base64-encoded data) failed. ('+e+")";A.log(n),i(new Error(n))})})},y.prototype._launchAsyncLoadTaskXHR=function(t){return new Promise((e,i)=>{const n=new XMLHttpRequest;n.open("GET",this._bufferData[t]),n.responseType="arraybuffer",n.onload=()=>{if(200===n.status)O(this._context,n.response,i=>{this._options.verbose&&A.log('BufferList: "'+this._bufferData[t]+'" successfully loaded.'),e(i)},e=>{const n='BufferList: decoding "'+this._bufferData[t]+'" failed. ('+e+")";A.log(n),i(new Error(n))});else{const e='BufferList: XHR error while loading "'+this._bufferData[t]+'". ('+n.status+" "+n.statusText+")";A.log(e),i(new Error(e))}},n.onerror=()=>{const e='BufferList: XHR network failed on loading "'+this._bufferData[t]+'".';A.log(e),i(new Error(e))},n.send()})};
/**
   * @license
   * Copyright 2016 Google Inc. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
   ...
   * limitations under the License.
   */
const F={DEFAULT:[0,1,2,3],SAFARI:[2,0,1,3],FUMA:[0,3,1,2]};function H(A,t){this._context=A,this._splitter=this._context.createChannelSplitter(4),this._merger=this._context.createChannelMerger(4),this.input=this._splitter,this.output=this._merger,this.setChannelMap(t||F.DEFAULT)}
/**
   * @license
   * Copyright 2016 Google Inc. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
/**
   ...
   * limitations under the License.
   */
function Y(A,t,e){this._context=A,this._active=!1,this._isBufferLoaded=!1,this._ambisonicOrder=t,this._numberOfChannels=(this._ambisonicOrder+1)*(this._ambisonicOrder+1),this._buildAudioGraph(),e&&this.setHRIRBufferList(e),this.enable()}
/**
   * @license
   * Copyright 2016 Google Inc. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
/**
   ...
   * limitations under the License.
   */
const iA={getBrowserInfo:function(){if("undefined"==typeof window||"undefined"==typeof navigator)return{name:"unknown",version:"0",platform:"unknown"};const A=navigator.userAgent;let t,e=A.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*([\d.]+)/i)||[];if(/trident/i.test(e[1]))return t=/\brv[ :]+(\d+)/g.exec(A)||[],{name:"IE",version:t[1]||""};if("Chrome"===e[1]&&(t=A.match(/\bOPR|Edge\/(\d+)/),null!=t))return{name:"Opera",version:t[1]};e=e[2]?[e[1],e[2]]:[navigator.appName,navigator.appVersion,"-?"],null!=(t=A.match(/version\/([\d.]+)/i))&&e.splice(1,1,t[1]);let i=A.match(/android|ipad|iphone/i);return i||(i=A.match(/cros|linux|mac os x|windows/i)),{name:e[0],version:e[1],platform:i?i[0]:"unknown"}},patchSafari:function(){"undefined"!=typeof window&&window.webkitAudioContext&&window.webkitOfflineAudioContext&&(window.AudioContext=window.webkitAudioContext,window.OfflineAudioContext=window.webkitOfflineAudioContext)}},nA={};return nA.browserInfo=iA.getBrowserInfo(),nA.createBufferList=function(A,t,e){return new y(A,t,e||{dataType:"url"}).load()},nA.mergeBufferListByChannel=A.mergeBufferListByChannel,nA.splitBufferByChannel=A.splitBufferByChannel,nA.createFOAConvolver=function(A,t){return new R(A,t)},nA.createFOARouter=function(A,t){return new H(A,t)},nA.createFOARotator=function(A){return new L(A)},nA.createHOARotator=function(A,t){return new V(A,t)},nA.createHOAConvolver=function(A,t,e){return new Y(A,t,e)},nA.createFOARenderer=function(A,t){return new U(A,t)},nA.createHOARenderer=function(A,t){return new eA(A,t)},A.log(`Version 1.4.0 (running ${nA.browserInfo.name} ${nA.browserInfo.version} on ${nA.browserInfo.platform})`),"safari"===nA.browserInfo.name.toLowerCase()&&(iA.patchSafari(),A.log(`${nA.browserInfo.name} detected. Polyfill applied.`)),nA});
