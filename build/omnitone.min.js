...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */const A={};let t,e,i,n,r,o,s,a,h,w,g,D,f,c,v,P,B,u,l,Q,C,_,d,E,M,p,I,x,m;A.log=function(){const A=`[Omnitone] ${Array.prototype.slice.call(arguments).join(" ")} (${performance.now().toFixed(2)}ms)`;window.console.log(A)},A.throw=function(){const A=`[Omnitone] ${Array.prototype.slice.call(arguments).join(" ")} (${performance.now().toFixed(2)}ms)`;throw new Error(A)},A.invertMatrix4=function(A,b){return t=b[0],e=b[1],i=b[2],n=b[3],r=b[4],o=b[5],s=b[6],a=b[7],h=b[8],w=b[9],g=b[10],D=b[11],f=b[12],c=b[13],v=b[14],P=b[15],B=t*o-e*r,u=t*s-i*r,l=t*a-n*r,Q=e*s-i*o,C=e*a-n*o,_=i*a-n*s,d=h*c-w*f,E=h*v-g*f,M=h*P-D*f,p=w*v-g*c,I=w*P-D*c,x=g*P-D*v,m=B*x-u*I+l*p+Q*M-C*E+_*d,m?(m=1/m,A[0]=(o*x-s*I+a*p)*m,A[1]=(i*I-e*x-n*p)*m,A[2]=(c*_-v*C+P*Q)*m,A[3]=(g*C-w*_-D*Q)*m,A[4]=(s*M-r*x-a*E)*m,A[5]=(t*x-i*M+n*E)*m,A[6]=(v*l-f*_-P*u)*m,A[7]=(h*_-g*l+D*u)*m,A[8]=(r*I-o*M+a*d)*m,A[9]=(e*M-t*I-n*d)*m,A[10]=(f*C-c*l+P*B)*m,A[11]=(w*l-h*C-D*B)*m,A[12]=(o*E-r*p-s*d)*m,A[13]=(t*p-e*E+i*d)*m,A[14]=(c*u-f*Q-v*B)*m,A[15]=(h*Q-w*u+g*B)*m,A):null},A.isDefinedENUMEntry=function(A,t){for(const e in A)if(t===A[e])return!0;return!1},A.isAudioContext=function(A){return A instanceof AudioContext||A instanceof OfflineAudioContext},A.isAudioBuffer=function(A){return A instanceof AudioBuffer},A.mergeBufferListByChannel=function(t,e){const i=e[0].length,n=e[0].sampleRate;let r=0;for(let t=0;t<e.length;++t)r>32&&A.throw("Utils.mergeBuffer: Number of channels cannot exceed 32.(got "+r+")"),i!==e[t].length&&A.throw("Utils.mergeBuffer: AudioBuffer lengths are inconsistent. (expected "+i+" but got "+e[t].length+")"),n!==e[t].sampleRate&&A.throw("Utils.mergeBuffer: AudioBuffer sample rates are inconsistent. (expected "+n+" but got "+e[t].sampleRate+")"),r+=e[t].numberOfChannels;const o=t.createBuffer(r,i,n);let s=0;for(let A=0;A<e.length;++A)for(let t=0;t<e[A].numberOfChannels;++t)o.getChannelData(s++).set(e[A].getChannelData(t));return o},A.splitBufferByChannel=function(t,e,i){e.numberOfChannels<=i&&A.throw("Utils.splitBuffer: Insufficient number of channels. ("+e.numberOfChannels+" splitted by "+i+")");const n=[];let r=0;const o=Math.ceil(e.numberOfChannels/i);for(let A=0;A<o;++A){const A=t.createBuffer(i,e.length,e.sampleRate);for(let t=0;t<i;++t)r<e.numberOfChannels&&A.getChannelData(t).set(e.getChannelData(r++));n.push(A)}return n},A.getArrayBufferFromBase64String=function(A){const t=window.atob(A),e=new Uint8Array(t.length);return e.forEach((A,i)=>e[i]=t.charCodeAt(i)),e.buffer};
/**
   * @license
   ...
   * limitations under the License.
   */
const b={BASE64:"base64",URL:"url"};function O(t,e,i){this._context=A.isAudioContext(t)?t:A.throw("BufferList: Invalid BaseAudioContext."),this._options={dataType:b.BASE64,verbose:!1},i&&(i.dataType&&A.isDefinedENUMEntry(b,i.dataType)&&(this._options.dataType=i.dataType),i.verbose&&(this._options.verbose=Boolean(i.verbose))),this._bufferList=[],this._bufferData=this._options.dataType===b.BASE64?e:e.slice(0)}O.prototype.load=function(){const t=this._bufferData.map((A,t)=>this._options.dataType===b.BASE64?this._launchAsyncLoadTask(t):this._launchAsyncLoadTaskXHR(t));return Promise.all(t).then(t=>{this._bufferList=t;const e=this._options.dataType===b.BASE64?this._bufferData.length+" AudioBuffers from Base64-encoded HRIRs":this._bufferData.length+" files via XHR";return A.log("BufferList: "+e+" loaded successfully."),t})},O.prototype._launchAsyncLoadTask=function(t){return new Promise((e,i)=>{let n;try{n=A.getArrayBufferFromBase64String(this._bufferData[t])}catch(A){return void i(new Error("BufferList: invalid Base64 at index "+t))}this._context.decodeAudioData(n,i=>{this._options.verbose&&A.log("BufferList: ArrayBuffer("+t+") from Base64-encoded HRIR successfully loaded."),e(i)},e=>{const n='BufferList: decoding ArrayBuffer("'+t+'" from Base64-encoded data) failed. ('+e+")";A.log(n),i(new Error(n))})})},O.prototype._launchAsyncLoadTaskXHR=function(t){return new Promise((e,i)=>{const n=new XMLHttpRequest;n.open("GET",this._bufferData[t]),n.responseType="arraybuffer",n.onload=()=>{if(200===n.status)this._context.decodeAudioData(n.response,i=>{this._options.verbose&&A.log('BufferList: "'+this._bufferData[t]+'" successfully loaded.'),e(i)},e=>{const n='BufferList: decoding "'+this._bufferData[t]+'" failed. ('+e+")";A.log(n),i(new Error(n))});else{const e='BufferList: XHR error while loading "'+this._bufferData[t]+'". ('+n.status+" "+n.statusText+")";A.log(e),i(new Error(e))}},n.onerror=()=>{const e='BufferList: XHR network failed on loading "'+this._bufferData[t]+'".';A.log(e),i(new Error(e))},n.send()})};
/**
   * @license
   * Copyright 2016 Google Inc. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
   ...
   * limitations under the License.
   */
const y={DEFAULT:[0,1,2,3],SAFARI:[2,0,1,3],FUMA:[0,3,1,2]};function F(A,t){this._context=A,this._splitter=this._context.createChannelSplitter(4),this._merger=this._context.createChannelMerger(4),this.input=this._splitter,this.output=this._merger,this.setChannelMap(t||y.DEFAULT)}
/**
   * @license
   * Copyright 2016 Google Inc. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */function G(t,e){this._context=A.isAudioContext(t)?t:A.throw("FOARenderer: Invalid BaseAudioContext."),this._config={channelMap:F.ChannelMap.DEFAULT,renderingMode:z.AMBISONIC},e&&(e.channelMap&&(Array.isArray(e.channelMap)&&4===e.channelMap.length?this._config.channelMap=e.channelMap:A.throw("FOARenderer: Invalid channel map. (got "+e.channelMap+")")),e.hrirPathList&&(Array.isArray(e.hrirPathList)&&2===e.hrirPathList.length?this._config.pathList=e.hrirPathList:A.throw("FOARenderer: Invalid HRIR URLs. It must be an array with 2 URLs to HRIR files. (got "+e.hrirPathList+")")),e.renderingMode&&(Object.values(z).includes(e.renderingMode)?this._config.renderingMode=e.renderingMode:A.log("FOARenderer: Invalid rendering mode order. (got"+e.renderingMode+') Fallbacks to the mode "ambisonic".'))),this._buildAudioGraph(),this._renderingMode=z.AMBISONIC,this._tempMatrix4=new Float32Array(16),this._isRendererReady=!1}
/**
   * @license
   * Copyright 2017 Google Inc. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
   ...
   * limitations under the License.
   */
function U(A,t,e){this._context=A,this._active=!1,this._isBufferLoaded=!1,this._ambisonicOrder=t,this._numberOfChannels=(this._ambisonicOrder+1)*(this._ambisonicOrder+1),this._buildAudioGraph(),e&&this.setHRIRBufferList(e),this.enable()}
/**
   * @license
   * Copyright 2016 Google Inc. All Rights Reserved.
   * Licensed under the Apache License, Version 2.0 (the "License");
...
/**
   ...
   * limitations under the License.
   */
const eA={getBrowserInfo:function(){const A=navigator.userAgent;let t,e=A.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*([\d.]+)/i)||[];if(/trident/i.test(e[1]))return t=/\brv[ :]+(\d+)/g.exec(A)||[],{name:"IE",version:t[1]||""};if("Chrome"===e[1]&&(t=A.match(/\bOPR|Edge\/(\d+)/),null!=t))return{name:"Opera",version:t[1]};e=e[2]?[e[1],e[2]]:[navigator.appName,navigator.appVersion,"-?"],null!=(t=A.match(/version\/([\d.]+)/i))&&e.splice(1,1,t[1]);let i=A.match(/android|ipad|iphone/i);return i||(i=A.match(/cros|linux|mac os x|windows/i)),{name:e[0],version:e[1],platform:i?i[0]:"unknown"}},patchSafari:function(){window.webkitAudioContext&&window.webkitOfflineAudioContext&&(window.AudioContext=window.webkitAudioContext,window.OfflineAudioContext=window.webkitOfflineAudioContext)}},iA={};return iA.browserInfo=eA.getBrowserInfo(),iA.createBufferList=function(A,t,e){return new O(A,t,e||{dataType:"url"}).load()},iA.mergeBufferListByChannel=A.mergeBufferListByChannel,iA.splitBufferByChannel=A.splitBufferByChannel,iA.createFOAConvolver=function(A,t){return new R(A,t)},iA.createFOARouter=function(A,t){return new F(A,t)},iA.createFOARotator=function(A){return new H(A)},iA.createHOARotator=function(A,t){return new W(A,t)},iA.createHOAConvolver=function(A,t,e){return new U(A,t,e)},iA.createFOARenderer=function(A,t){return new G(A,t)},iA.createHOARenderer=function(A,t){return new tA(A,t)},A.log(`Version 1.4.0 (running ${iA.browserInfo.name} ${iA.browserInfo.version} on ${iA.browserInfo.platform})`),"safari"===iA.browserInfo.name.toLowerCase()&&(eA.patchSafari(),A.log(`${iA.browserInfo.name} detected. Polyfill applied.`)),iA}();
